...
VL_INLINE_OPT void Vtop___024root___sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    if (vlSelf->Top__DOT__RegWrite) {
        __Vdlyvval__Top__DOT__Register__DOT__mem__v0 
            = ((IData)(vlSelf->Top__DOT__ResultSrc)
                ? vlSelf->Top__DOT__ALUResult : ((vlSelf->Top__DOT__data_ram__DOT__data_mem
                                                  [
                                                  (0xffU 
                                                   & ((IData)(3U) 
    ...
    vlSelf->a0 = vlSelf->Top__DOT__Register__DOT__mem
        [0xaU];
    vlSelf->Top__DOT__instr = ((vlSelf->Top__DOT__Instruction__DOT__rom_array
                                [(0xffU & ((IData)(3U) 
                                           + vlSelf->Top__DOT__PC))] 
                                << 0x18U) | ((vlSelf->Top__DOT__Instruction__DOT__rom_array
                                              [(0xffU 
                                                & ((IData)(2U) 
                                                   + vlSelf->Top__DOT__PC))] 
                                              << 0x10U) 
                                             | ((vlSelf->Top__DOT__Instruction__DOT__rom_array
                                                ...
                                                [(0xffU 
                                                  & vlSelf->Top__DOT__PC)])));
    if ((0U == (3U & vlSelf->Top__DOT__instr))) {
        vlSelf->Top__DOT__ALUctrl = 0U;
    } else if ((1U == (3U & vlSelf->Top__DOT__instr))) {
        vlSelf->Top__DOT__ALUctrl = 1U;
    } else if ((2U == (3U & vlSelf->Top__DOT__instr))) {
        vlSelf->Top__DOT__ALUctrl = 0U;
    }
    ...
    if ((3U == (0x7fU & vlSelf->Top__DOT__instr))) {
        ...
        if ((1U == (7U & (vlSelf->Top__DOT__instr >> 0xcU)))) {
            vlSelf->Top__DOT__RegWrite = 0U;
            vlSelf->Top__DOT__ResultSrc = 0U;
            vlSelf->Top__DOT__MemWrite = 0U;
            vlSelf->Top__DOT__ALUSrc = 1U;
    ...
    if ((3U == (0x7fU & vlSelf->Top__DOT__instr))) {
        ...
        if ((0U == (7U & (vlSelf->Top__DOT__instr >> 0xcU)))) {
            vlSelf->Top__DOT__PCsrc = vlSelf->Top__DOT__EQ;
        }
        if ((1U == (7U & (vlSelf->Top__DOT__instr >> 0xcU)))) {
    ...
    vlSelf->Top__DOT__ProgramCounter__DOT__next_PC 
        = ((IData)(vlSelf->Top__DOT__PCsrc) ? ((IData)(4U) 
                                               + vlSelf->Top__DOT__PC)
            : (vlSelf->Top__DOT__PC + vlSelf->Top__DOT__ImmOp));
}
